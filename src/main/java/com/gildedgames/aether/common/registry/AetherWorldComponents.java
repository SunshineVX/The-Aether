...
public class AetherWorldComponents {
    @Deprecated // Turns out Vanilla has a replacement for this
    ...
    // TODO check again if vanilla has a replacement for this
    ...
    static {
        ...
        Registry.register(Registry.CHUNK_GENERATOR, new ResourceLocation(Aether.MODID, "graph_test"), GraphingGenerator.CODEC);
    }
